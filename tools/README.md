...
| `release/`      | How does it become public?       | `build_release_archives.py`, `seal_edition.py`, `deploy.sh`, `deploy.sftp.lftp.template` (host/account from env, rendered by `render_deploy_lftp.py`), and `server/` (server-only files, never deployed).                                                                                                                                                            |
